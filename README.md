...
- **SMTP Reachability Test** – Test if the email address is reachable without sending an email.  
- **Promise-based API** – Fully asynchronous, works with `async/await`.  
- **Lightweight & Secure** – Minimal dependencies, safe for production.  
